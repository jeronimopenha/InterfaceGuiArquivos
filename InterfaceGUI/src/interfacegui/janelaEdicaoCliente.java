 ...
 * @author Suporte
 */
public class janelaEdicaoCliente extends javax.swing.JDialog {

    private PersistirCliente persistirCliente;
     ...
     */
    public janelaEdicaoCliente(java.awt.Frame parent, boolean modal, JanelaPesquisaClientes janelaPesquisa) {
        super(parent, modal);
        initComponents();
        jtblCliente = janelaPesquisa.getJtblCliente();
        modelo = (DefaultTableModel) jtblCliente.getModel();
        persistirCliente = janelaPesquisa.getPersistirCliente();
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Edição de Clientes");
    ...
    private void jbtnSalvarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbtnSalvarMouseClicked
        ...
        modelo.setValueAt(jtxtNome.getText(), jtblCliente.getSelectedRow(), 0);
        modelo.setValueAt(jtxtRua.getText(), jtblCliente.getSelectedRow(), 1);
        modelo.setValueAt(jtxtBairro.getText(), jtblCliente.getSelectedRow(), 2);
        modelo.setValueAt(jftxtTelefone.getText(), jtblCliente.getSelectedRow(), 3);
        modelo.setValueAt(jtxtCidade.getText(), jtblCliente.getSelectedRow(), 4);
        modelo.setValueAt(jtxtNumero.getText(), jtblCliente.getSelectedRow(), 5);
    ...
    /**
     * @return the jftxtTelefone
     */
    public javax.swing.JFormattedTextField getJftxtTelefone() {
        return jftxtTelefone;
    }

    /**
     * @return the jtxtBairro
     */
    public javax.swing.JTextField getJtxtBairro() {
        return jtxtBairro;
    }

    /**
     * @return the jtxtCidade
     */
    public javax.swing.JTextField getJtxtCidade() {
        return jtxtCidade;
    }
    ...
    /**
     * @return the jtxtNumero
     */
    public javax.swing.JTextField getJtxtNumero() {
        return jtxtNumero;
    }
     ...
     * @return the jtxtRua
     */
    public javax.swing.JTextField getJtxtRua() {
        return jtxtRua;
    }
